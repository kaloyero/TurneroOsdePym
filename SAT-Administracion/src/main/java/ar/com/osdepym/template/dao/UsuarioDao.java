...
public class UsuarioDao {
	...
	public Usuario editarUsuario(Usuario usuarioEditar) {
		...
		String queryCantidadAdministradores = "Select * from SAT.usuario inner join sat.perfil on sat.usuario.id_perfil =sat.perfil.id_perfil where sat.perfil.nom_perfil ='Administrador'and sat.usuario.Habilitado ='SI' and sat.usuario.id_usuario <> "
